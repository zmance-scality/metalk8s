...
centralization system (e.g. Elasticisearch), he will need to define an
...
configuration, such as the retention or the number of replicas, and in the
simplest possible form for the user.
...
* Deploy Loki volumes purge mechanism
...
A new page should be added to explains how to operate the service and how to
